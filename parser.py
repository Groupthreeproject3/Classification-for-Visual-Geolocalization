...
def parse_arguments(is_training=True):
    ...
    parser.add_argument("--backbone1", type=str, default="resnet18",
                        choices=["vgg16", "resnet18", "resnet50", "resnet101"], help="_")
    parser.add_argument("--backbone2", type=str, default="vgg16",
                        choices=["vgg16", "resnet18", "resnet50", "resnet101"], help="_")
    parser.add_argument("--fc_output_dim", type=int, default=512,
                        help="Output dimension of final fully connected layer")

    # For the ensemble model with ResNet50 and ResNet101, the default values of the backbones and as well as the output_dim should be changed accordingly
    #parser.add_argument("--backbone1", type=str, default="resnet50",
    #                    choices=["vgg16", "resnet18", "resnet50", "resnet101"], help="_")
    #parser.add_argument("--backbone2", type=str, default="resnet101",
    #                    choices=["vgg16", "resnet18", "resnet50", "resnet101"], help="_")
    ...
    parser.add_argument("--augmentation_device", type=str, default="cpu",
                        choices=["cuda", "cpu"],
                        help="on which device to run data augmentation")
    parser.add_argument("--batch_size", type=int, default=15, help="_")
    parser.add_argument("--epochs_num", type=int, default=2, help="_")
    ...
    # Data augmentation with the added parameters
    parser.add_argument("--brightness", type=float, default=0.3, help="_")
    ...
    parser.add_argument("--distortion_scale", type=float, default=0.6, help="_")
    parser.add_argument("--p", type=float, default=0.1, help="_")
    parser.add_argument("--fill", type=float, default=10000, help="_")
    parser.add_argument("--value", type=float, default=0, help="_")
