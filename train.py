...
if args.augmentation_device == "cuda":
    gpu_augmentation = T.Compose([
            augmentations.DeviceAgnosticColorJitter(brightness=args.brightness,
                                                    ...
                                                    hue=args.hue),
            #This is used for the adjust transformation 
            augmentations.BrightnessTransform(brightness=args.brightness),
            #This is used for the Random Perspective transformation 
            augmentations.DeviceAgnosticRandomPerspective(distortion_scale=args.distortion_scale, 
                                                          p=args.p, fill=args.fill),
            #This is used for the Random Erasing transformation 
            augmentations.DeviceAgnosticRandomErasing(p=args.p,
                                                    scale=(0.02,0.33),
                                                    ratio=(0.3,3.3),
                                                    value=args.value,
                                                    inplace=False),
            augmentations.DeviceAgnosticRandomResizedCrop([128, 128],
